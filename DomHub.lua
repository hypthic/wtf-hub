...
local function NotificacaoNightMystic(titulo, mensagem)
    local success = pcall(function()
        ...
        local LogoID = "rbxassetid://3025004408"
...
Setting:AddButton({
    ...
    Callback = function()
        LowCpu()
        NotificacaoNightMystic("Dom Hub", "✅ Ultra Optimizer đã kích hoạt!")
    end
});
...
Setting:AddButton({
    ...
    Callback = function()
        ...
        pcall(function() collectgarbage("collect") end)
        pcall(function() collectgarbage() end)
        NotificacaoNightMystic("Dom Hub", "🧹 RAM đã được dọn sạch!")
    end
});
...
Setting:AddButton({
    ...
    Callback = function()
        ...
        NotificacaoNightMystic("Dom Hub", "✨ Đã xóa hiệu ứng NPC!")
    end
});
...
Setting:AddButton({
    ...
    Callback = function()
        ...
        NotificacaoNightMystic("Dom Hub", "🌑 Đang tắt shadow toàn map...")
    end
});
...
Setting:AddButton({
    ...
    Callback = function()
        ...
        NotificacaoNightMystic("Dom Hub", "💡 Đã xóa post-processing!")
    end
});
...
Setting:AddToggle({
    ...
    Callback = function(val)
        ...
        if val then
            ...
            NotificacaoNightMystic("Dom Hub", "🔄 Auto RAM Clean: BẬT")
        else
            NotificacaoNightMystic("Dom Hub", "🔄 Auto RAM Clean: TẮT")
        end
    end
});
...
Setting:AddButton({
    ...
    Callback = function()
        ...
        NotificacaoNightMystic("Dom Hub", "📺 Stretch Screen đã bật!")
    end
});
...
NotificacaoNightMystic("Dom Hub", "👋 Chào mừng đến với Dom Hub (Freemium)")
